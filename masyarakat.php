...
<style>
  ...
  left: 0;
  height: 100%;
  width: 225px; /* Atur lebar sidebar sesuai kebutuhan */
  z-index: 1;
...
#content-wrapper {
  margin-left: 225px; /* Sesuaikan dengan lebar sidebar */
  transition: all 0.3s;
}
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column" style="margin-right: 40px; padding: 35px;">
